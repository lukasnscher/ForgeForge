 ...
 * This file demonstrates how to integrate Forgeforge with a web frontend
 */

// For React/Vue/Angular applications
export class ForgeforgeClient {
    ...
    useEffect(() => {
        async function init() {
            try {
                ...
                const contractClient = new ForgeforgeClient(provider, contractAddress);
